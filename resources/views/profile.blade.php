                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-5 mx-auto">
                                                <label class="mt-2">Courriel</label>
                                                ...
                                                <input id="profile_picture" name="profile_picture" type="file" class="file-loading mt-2" data-show-preview="true">
                                                <label class="mt-2">Visibilité du profil</label>
                                                ...
                                                <label class="mt-3">Vérification du mot de passe</label>
